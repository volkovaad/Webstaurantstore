...
public class WeeklySalesCompareProducts extends TestBase{
    ...
    public void test() throws InterruptedException {
        ...
        weeklySales.getCompareProducts().click();

        Thread.sleep(1000);

        weeklySales.getCompareProduct1().click();
        weeklySales.getCompareProduct2().click();
        weeklySales.getCompareProductsResult().click();
